    ...
    public MainMenu() {
        ...
        entries.add(
                new MenuEntry("Customer Relations", "user",
                        ...
                        new MenuEntry("Helpdesk", null, Pages.HELPDESK, Pages.HELPDESK_CUSTOMER, Pages.HELPDESK_UPDATE_CUSTOMER_PROFILE, Pages.HELPDESK_UPDATE_MEMBERSHIP, Pages.HELPDESK_ISSUE_CARD, Pages.CUSTOMER_FLIGHT_BOOKINGS, Pages.SPECIAL_REQUEST_FORM),
                        new MenuEntry("Campaigns", null, Pages.VIEW_CAMPAIGNS, Pages.CREATE_CAMPAIGN, Pages.UPDATE_CAMPAIGN),
                        new MenuEntry("Customer Groups", null, Pages.VIEW_CUSTOMERGROUPS, Pages.CREATE_CUSTOMERGROUP, Pages.UPDATE_CUSTOMERGROUP, Pages.SEND_TARGETED_MAIL),
