...
public class Constants {
    ...
    public static final double OPERATIONAL_OCCUPANCY = 0.8;
    public static final double MILES_BEFORE_MAINTENANCE = 30000;
    ...
    public static final String SSR_ACTION_CODE_REQUEST = "RMK";
